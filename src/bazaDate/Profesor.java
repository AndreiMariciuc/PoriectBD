...
public class Profesor extends User{
    ...
    public Profesor(int idUser, int idRol, String CNP, String nume, String prenume, String adresa, String nrTelefon, String email, String IBAN, int nrContract, String username, String parola) {
